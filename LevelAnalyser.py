...
class LevelAnalyser:
    ...
    def getWallCount(self):
        ...
        for row in self.level:
            for tile in row:
                if tile == config.get().get("defined").get("wall"):
                    count += 1
    ...
    def getEmptyCount(self):
        ...
        for row in self.level:
            for tile in row:
                if tile == config.get().get("defined").get("nothing"):
                    count += 1
    ...
    def getLightCount(self):
        ...
        for row in self.level:
            for tile in row:
                if tile == config.get().get("defined").get("light"):
                    count += 1
    ...
    def getTempLightCount(self):
        ...
        for row in self.level:
            for tile in row:
                if tile == config.get().get("defined").get("tempLight"):
                    count += 1
